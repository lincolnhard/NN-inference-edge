...
if __name__ == '__main__':
    ...
    ### Mark groundtruth
    #===================
    baseroot = '/Users/lincolnlee/Documents/NN-inference-using-SNPE/tools/'
    ...
    out = net.forward()
    # print(sources[2].shape)
    # print(net.blobs['res52'].data.shape)
    # print(net.blobs['conv61'].data.shape)
    # print(np.max(np.abs((sources[2].numpy() - net.blobs['res52'].data))))
    # print(np.max(np.abs((sources[1].numpy() - net.blobs['res40'].data))))
    # print(np.max(np.abs((sources[0].numpy() - net.blobs['res20'].data))))

    # print(np.max(np.abs((fpn_feats[0].numpy() - net.blobs['conv61'].data))))
    # print(np.mean(np.abs((fpn_feats[0].numpy() - net.blobs['conv61'].data))))

    
    # print(cls_scores[0].shape)
    # print(vertex_preds[0].shape)
    # print(centernesses[0].shape)
    # print(occlusions[0].shape)
