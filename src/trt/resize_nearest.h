...
class ResizeNearest : public ResizePlugin {
   public:
    ResizeNearest();
    virtual ~ResizeNearest();
    ...
    ///     resize_bilinear
    ResizeNearest(nvinfer1::Dims const input_dims,
    ...
    ///     created
    ResizeNearest(void const *data, size_t const length);
...
class ResizeNearestPluginCreator : public ResizePluginCreator {
   public:
