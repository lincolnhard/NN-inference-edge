...
#define SLOG_INFO gallopwave::LogStream::logInfo(LOG)
#define SLOG_WARN gallopwave::LogStream::logWarn(LOG)
#define SLOG_ERROR gallopwave::LogStream::logError(LOG)
#define SLOG_DEBUG gallopwave::LogStream::logDebug(LOG)
#define THROW_EXCEPTION gallopwave::LogStream::throwExeption()<<__func__<<'('<<__FILE__<<"): "
